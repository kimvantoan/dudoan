              ...
              <div className="space-y-6">
                <div className="bg-indigo-950/20 border border-indigo-900/40 p-3.5 rounded-xl flex items-center justify-between text-xs animate-fade-in gap-3">
                  ...
                  {token && !isOutrightLocked && (
                    <button
                      disabled={!outrightInput[subTab]}
                      onClick={() => handleSaveOutright(subTab, outrightInput[subTab])}
                      className="bg-indigo-600 hover:bg-indigo-550 disabled:opacity-40 disabled:cursor-not-allowed text-white font-extrabold text-[11px] px-4 py-2 rounded-xl transition-all cursor-pointer shadow shrink-0"
                    >
                      Lưu dự đoán
                    </button>
                  )}
            ...
            {subTab === 'golden_boot' && (
              <div className="space-y-5">
                <div className="bg-indigo-950/20 border border-indigo-900/40 p-3.5 rounded-xl flex items-center justify-between text-xs animate-fade-in gap-3">
                  ...
                  {token && !isOutrightLocked && (
                    <button
                      disabled={!outrightInput.golden_boot}
                      onClick={() => handleSaveOutright('golden_boot', outrightInput.golden_boot)}
                      className="bg-indigo-600 hover:bg-indigo-550 disabled:opacity-40 disabled:cursor-not-allowed text-white font-extrabold text-[11px] px-4 py-2 rounded-xl transition-all cursor-pointer shadow shrink-0"
                    >
                      Lưu dự đoán
                    </button>
                  ...
                  <div className="bg-indigo-950/20 border border-indigo-900/40 p-3.5 rounded-xl flex items-center justify-between text-xs gap-3">
                    ...
                    {token && !isOutrightLocked && (
                      <button
                        ...
                        className="bg-indigo-600 hover:bg-indigo-550 text-white font-extrabold text-[11px] px-4 py-2 rounded-xl transition-all cursor-pointer shadow shrink-0"
                      >
                        Lưu dự đoán
                      </button>
                    )}
